...
$qry =  "select sw_pid.post,sw_pid.p_id,sw_post.d_ate,sw_post.t_ime,sw_post.usend_id from sw_pid,sw_post where sw_post.urev_id = '$_SESSION[advanced]' and sw_post.pid = sw_pid.p_id order by sw_post.d_ate desc, sw_post.t_ime desc;";
//echo $qry;
